...
task CreateNuGetPackage -depends Compile {
	...
	exec { . $nuget_path pack $dist_directory\IdentityServer3.AccessTokenValidation.nuspec -BasePath $dist_directory -OutputDirectory $dist_directory -version $packageVersion }
}
